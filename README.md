...
<img src="https://latex.codecogs.com/svg.latex?\Large&space;(1)\quad\quad\text{minimize}\quad\quad\frac{1}{2}\|\Psi \Delta U-\Phi\|_2^2+\|\Delta U\|_1" title="\Large \text{minimize}\quad\quad\frac{1}{2}\|\Psi \Delta U-\Phi\|_2^2 + \|\Delta U\|_1" />
