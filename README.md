...
<img src="https://latex.codecogs.com/svg.latex?\Large&space;(1)\quad\quad\frac{1}{2}\|\Lambda^{\frac{1}{2}}\Delta U(k_i) -\Lambda^{-\frac{1}{2}}\Phi^\top Q\big(R_s - \Psi x(k_i)\big)\|_2^2 + \|x\|_p" title="\Large \text{minimize}\quad\quad\frac{1}{2}\|\Lambda^{\frac{1}{2}}\Delta U(k_i) -\Lambda^{-\frac{1}{2}}\Phi^\top Q\big(R_s - \Psi x(k_i)\big)\|_2^2 + \|x\|_p" />
