...
<img src="https://latex.codecogs.com/svg.latex?\Large&space;(1)\quad\quad\text{minimize}\quad\quad\frac{1}{2}\|H dU-b\|_2^2+\|dU\|_1" title="\Large \text{minimize}\quad\quad\frac{1}{2}\|H dU-b\|_2^2 + \|dU\|_1" />
