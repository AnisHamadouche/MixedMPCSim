...
<img src="https://latex.codecogs.com/svg.latex?\Large&space;(1)\quad\quad\text{minimize}\quad\quad\frac{1}{2}\|\Lambda~\Delta~U-\Gamma\|_2^2+\|\Delta~U\|_p" title="\Large \text{minimize}\quad\quad\frac{1}{2}\|\Lambda~\Delta~U-\Gamma\|_2^2 + \|\Delta~U\|_p" />
...
<figure>
  ...
  <figcaption align="center">Fig.1 Fixed Point MPC control signals outputs.</figcaption>
</figure>
...
<figure>
  ...
  <figcaption align="center">Fig.2 Fixed Point MPC differential control signal.</figcaption>
</figure>
