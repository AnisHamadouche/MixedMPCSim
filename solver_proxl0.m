...
function [u_prox,F_prox_subopt,e1,e2,u0,k] = solver_proxl0(x0,A, b, n, N, gamma,L,MAX_ITER,ABSTOL,lambda,delta,epsilon0)
...
%   minimize(sum_square(A * u - b)+gamma*l1_norm(u))
    ...
    for k = 1:MAX_ITER
        ...
        while 1
            ...
            z = prox_l0(x - tk*grad_x, gamma);%+sqrt(2*e2(k)/(L*n*N));
