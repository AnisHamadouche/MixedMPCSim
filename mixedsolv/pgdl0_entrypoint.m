function [dU,F_prox_subopt] = pgdl0_entrypoint(x0,A, b, Atb, n, N, gamma,L,MAX_ITER,ABSTOL,lambda,frmt)
    ...
    [dU,F_prox_subopt] = solver_proxl0(x0, grad_x0, A, b,AtA,Atb, n, N, gamma,L,MAX_ITER,ABSTOL,lambda);
    dU = double(dU);
