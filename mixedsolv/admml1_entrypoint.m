function [z,admm_optval] = admml1_entrypoint(x0,z0,A, b, Atb, lambda, gamma, rho, MAX_ITER,ABSTOL, RELTOL,frmt)
    ...
    [z,admm_optval] = solver_admml1(x0,z0,u0,q,A, b, Atb, lambda, gamma, rho, MAX_ITER,ABSTOL, RELTOL);
    z = double(z);
